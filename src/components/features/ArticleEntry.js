...
const ArticleEntry = ({
    ...
    return (
      <div className="relative w-[80%] h-60 bg-cover">
        <div className={`absolute ${borderRadius} inset-0 bg-gradient-to-r shadow-xl shadow-slate-900 ${gradient}`}/>
        <div className={`flex ${flexDirection} space-x-12 justify-center h-full`}>
          <div className='overflow-hidden'>
            <Gallery number={article}/>
          </div>
          <div className="w-[60%] relative font-CourierPrimeRegular flex flex-col space-y-8 justify-center text-white text-left">
            ...
            <div className='flex flex-col items-start'>
              ...
              <p className="text-md- overflow-ellipsis line-clamp-1">
                {subHeader}
              </p>
